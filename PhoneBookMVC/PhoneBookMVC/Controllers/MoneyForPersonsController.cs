...
namespace PhoneBookMVC.Controllers
{
    public class MoneyForPersonsController : Controller
    {
        ...
        {
            var moneyForPersons = db.MoneyForPersons.Include(m => m.Person);
            return View(moneyForPersons.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            MoneyForPerson moneyForPerson = db.MoneyForPersons.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,PersonId,Salary")] MoneyForPerson moneyForPerson)
        {
            ...
            {
                db.MoneyForPersons.Add(moneyForPerson);
                db.SaveChanges();
                return RedirectToAction("Index");
            }

            ViewBag.PersonId = new SelectList(db.People, "Id", "Name", moneyForPerson.PersonId);
            return View(moneyForPerson);
        }
        ...
        {
            MoneyForPerson moneyForPerson = db.MoneyForPersons.Find(id);
            db.MoneyForPersons.Remove(moneyForPerson);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
